...
:
    ...
    // Nam 
    Dimix_(this->specieThermos().size()),  
    DimixT_(this->specieThermos().size()), 
    Dij_(this->specieThermos().size()),    
    Wmix_
    (
        IOobject
        (
            //"Wmix",
            BasicThermoType::phasePropertyName("Wmix", phaseName),   
            mesh.time().name(),
            mesh,
            IOobject::NO_READ,
            IOobject::NO_WRITE
    ...
    heList_(this->specieThermos().size())
    // Nam
{
    ...
    forAll(Dimix_, i)
    {
        ...
        (
            ...
            (
                IOobject
                (
                    BasicThermoType::phasePropertyName("thermo:Dimix", phaseName),                   
                    mesh.time().name(),
                    mesh,
                    IOobject::NO_READ,
                    IOobject::NO_WRITE
    ...
    forAll(DimixT_, i)
    {
        ...
        (
            ...
            (
                IOobject
                (
                    BasicThermoType::phasePropertyName("thermo:DimixT", phaseName),                        
                    mesh.time().name(),
                    mesh,
                    IOobject::NO_READ,
                    IOobject::NO_WRITE
    ...
    forAll(Dij_, i)
    {
        Dij_[i] = PtrList<volScalarField>(this->specieThermos().size());
        ...
        forAll(Dij_[i], j)
        {
            ...
            (
                ...
                (
                    IOobject
                    (
                        BasicThermoType::phasePropertyName("thermo:Dij", phaseName),                             
                        mesh.time().name(),
                        mesh,
                        IOobject::NO_READ,
                        IOobject::NO_WRITE
    ...
    forAll(heList_, i)
    {
        ...
        (
            ...
            (
                IOobject
                (
                    BasicThermoType::phasePropertyName("thermo:hei", phaseName), 
                    mesh.time().name(),
                    mesh,
                    IOobject::NO_READ,
                    IOobject::NO_WRITE
