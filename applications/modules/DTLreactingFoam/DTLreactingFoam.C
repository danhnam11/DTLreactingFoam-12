...
namespace solvers
{
    defineTypeNameAndDebug(DTLreactingFoam, 0);
    addToRunTimeSelectionTable(solver, DTLreactingFoam, fvMesh);
}
}
...
Foam::solvers::DTLreactingFoam::DTLreactingFoam(fvMesh& mesh)
:
    isothermalFluid
    (
        mesh,
...
Foam::solvers::DTLreactingFoam::~DTLreactingFoam()
{}


// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

void Foam::solvers::DTLreactingFoam::prePredictor()
{
...
void Foam::solvers::DTLreactingFoam::postCorrector()
{
...
void Foam::solvers::DTLreactingFoam::postSolve()
{
...
void Foam::solvers::DTLreactingFoam::calculateAndUpdateCoTHERMFlags()
{
